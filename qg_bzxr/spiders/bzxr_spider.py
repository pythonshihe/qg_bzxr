...
from work_utils.get_keywords import get_keywords
import time
import logging
...
class BzxrSpiderSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for sur in sur_tuple[0:100]:  # 访问前一百个姓氏的数据
            for keyword in key_words_tuple:
                ...
                yield scrapy.FormRequest(url=url, formdata=form_data, callback=self.page_parse, dont_filter=True,
                                         meta=meta)
    ...
    def parse_data(self, response):  # 解析详情页数据
